...
Options:
  ...
  --mode [p|c]          Run mode, default is 'p'. allow p: multi-process c: multi-coroutine
...
STR;
    ...
    public function __invoke(App $app)
    {
        ...
        $this->subDirs = $this->allComponents($app);
        $this->counts  = count($this->subDirs);

        Color::println("will handled component number: $this->counts");
    ...
    private function coroutineRun(array $subDirs): array
    {
        $result = [];
        $runner = CoScheduler::new();
        $branch = $this->branch;
    ...
    private function processRun(): array
    {
